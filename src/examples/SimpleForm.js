  ...
  return (<div className="form-horizontal">
      <div className="form-group">
        ...
        <div className="col-xs-8">
          <input type="text" className="col-xs-8 form-control" {...firstName}/>
        </div>
      </div>
      <div className="form-group">
        <label className="col-xs-4 control-label">Last Name</label>
        <div className="col-xs-8">
          <input type="text" className="col-xs-8 form-control" {...lastName}/>
        </div>
      </div>
      <div className="form-group">
        <label className="col-xs-4 control-label">Email</label>
        <div className="col-xs-8">
          <input type="text" className="col-xs-8 form-control" {...email}/>
        </div>
      </div>
      <div className="form-group">

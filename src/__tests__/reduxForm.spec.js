...
const describeReduxForm = (name, structure, combineReducers, expect) => {
  ...
  describe(name, () => {
    ...
    it('should retain the value of dirty fields upon reinitialization', () => {
      const store = makeStore({})
      const inputRender = createSpy(props => <input {...props.input}/>).andCallThrough()
      const formRender = createSpy()
      const initialValues1 = {
    ...
    it('should make pristine any dirty field that has the new initial value upon reinitialization', () => {
      const store = makeStore({})
      const inputRender = createSpy(props => <input {...props.input}/>).andCallThrough()
      const formRender = createSpy()
      const initialValues1 = {

 ...
 */
const createReduxFormConnector = (isReactNative, React, connect) => (
  WrappedComponent,
  mapStateToProps,
  mapDispatchToProps,
  mergeProps,
  ...
  class ReduxFormConnector extends Component {
    ...
    UNSAFE_componentWillReceiveProps(nextProps) {
      this.cache.componentWillReceiveProps(nextProps); //this is not a react component, so not changing
    }

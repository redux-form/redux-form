...
*Note that, by default, the key used to pass the `redux-form` reducer to `combineReducers` should be named* **`form`**. *Although there is support for custom key names, see [`getFormState` config](http://redux-form.com/6.6.1/docs/api/ReduxForm.md/#-getformstate-function-optional-) for more details.*
...
[Simple Form Example](https://redux-form.com/6.6.1/examples/simple).

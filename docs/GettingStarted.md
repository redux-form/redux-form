...
[action creators](http://redux-form.com/8.0.0/docs/api/ActionCreators.md/) for
...
[`getFormState` config](http://redux-form.com/8.0.0/docs/api/ReduxForm.md/#-getformstate-function-optional-)
for more details.
...
the [docs](http://redux-form.com/8.0.0/docs/api/Field.md/#usage) to find out
more.
...
[examples](http://redux-form.com/8.0.0/examples/). The common next steps could
also be:

- setting the
  [initial form values](http://redux-form.com/8.0.0/examples/initializeFromState/),
- implementing the
  [validation](http://redux-form.com/8.0.0/examples/syncValidation/),
- creating dynamic forms with
  [arrays of fields](http://redux-form.com/8.0.0/examples/fieldArrays/).

...
[`props`](http://redux-form.com/8.2.2/docs/api/Props.md/) that will be injected
...
[`Field`](http://redux-form.com/8.2.2/docs/api/Field.md/) to your field
component.
...
This will give you the shape of the props provided from
[`Fields`](http://redux-form.com/8.2.2/docs/api/Fields.md/) to your fields
component.
...
This will give you the shape of the props provided from
[`FieldArray`](http://redux-form.com/8.2.2/docs/api/FieldArray.md/) to your

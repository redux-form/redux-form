...
> See [Asynchronous Blur Validation Example](http://redux-form.com/6.0.0-rc.2/examples/asyncValidation/)
for more details.
...
> See [Synchronous Validation Example](http://redux-form.com/6.0.0-rc.2/examples/syncValidation/)
for more details.

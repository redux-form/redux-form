...
> See [Asynchronous Blur Validation Example](https://redux-form.com/6.1.0/examples/asyncValidation/)
for more details.
...
> See [Synchronous Validation Example](https://redux-form.com/6.1.0/examples/syncValidation/)
for more details.

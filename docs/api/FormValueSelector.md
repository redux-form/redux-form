...
gave to [`reduxForm()`](https://redux-form.com/7.0.0/docs/api/ReduxForm.md/).
...
See the
[Selecting Form Values](https://redux-form.com/7.0.0/examples/selectingFormValues/) example.

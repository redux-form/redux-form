...
gave to [`reduxForm()`](https://redux-form.com/6.6.0/docs/api/ReduxForm.md/).
...
See the
[Selecting Form Values](https://redux-form.com/6.6.0/examples/selectingFormValues/) example.

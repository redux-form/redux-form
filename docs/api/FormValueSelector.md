...
gave to [`reduxForm()`](https://redux-form.com/6.1.1/docs/api/ReduxForm.md/).
...
See the
[Selecting Form Values](https://redux-form.com/6.1.1/examples/selectingFormValues/) example.

...
gave to [`reduxForm()`](https://redux-form.com/6.6.3/docs/api/ReduxForm.md/).
...
See the
[Selecting Form Values](https://redux-form.com/6.6.3/examples/selectingFormValues/) example.

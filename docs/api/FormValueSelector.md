...
gave to [`reduxForm()`](https://redux-form.com/6.0.5/docs/api/ReduxForm.md/).
...
See the
[Selecting Form Values](https://redux-form.com/6.0.5/examples/selectingFormValues/) example.

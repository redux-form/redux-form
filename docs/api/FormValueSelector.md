...
gave to [`reduxForm()`](http://redux-form.com/6.0.0-alpha.11/docs/api/ReduxForm.md/).
...
See the
[Selecting Form Values](http://redux-form.com/6.0.0-alpha.11/examples/selectingFormValues/) example.

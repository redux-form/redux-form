...
gave to [`reduxForm()`](https://redux-form.com/7.0.3/docs/api/ReduxForm.md/).
...
See the
[Selecting Form Values](https://redux-form.com/7.0.3/examples/selectingFormValues/) example.

...
gave to [`reduxForm()`](http://redux-form.com/6.0.0-rc.3/docs/api/ReduxForm.md/).
...
See the
[Selecting Form Values](http://redux-form.com/6.0.0-rc.3/examples/selectingFormValues/) example.

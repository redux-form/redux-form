...
gave to [`reduxForm()`](https://redux-form.com/6.6.2/docs/api/ReduxForm.md/).
...
See the
[Selecting Form Values](https://redux-form.com/6.6.2/examples/selectingFormValues/) example.

...
[`Field`](https://redux-form.com/6.0.5/docs/api/Field.md/) component, but operates on multiple
...
[`FieldArray`](https://redux-form.com/6.0.5/docs/api/FieldArray.md/)),
...
that `Field` generates](https://redux-form.com/6.0.5/docs/api/Field.md/#props), except that

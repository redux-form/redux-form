...
3. All other props will be passed along to the element generated by the `component` prop. If 
you are using a custom component, the additional props will be under the `input` key.
e.g. `props.input.className`.

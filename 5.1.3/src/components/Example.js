  ...
  render() {
    ...
    return (<div className="container">
      ...
      {fields && false && <div>
        ...
        <p>Below is a readonly component that is listening to the values in the <code>{form}</code>
          Redux form.</p>
      ...
      <p>
        The code below is literally the exact same code running in the example above. Styling has
        been removed for
        clarity.
      </p>
...
export default connect(undefined, { submit: showResults })(Example)

...
var mergeErrors = function mergeErrors(_ref) {
  ...
  return asyncErrors && _immutable.Iterable.isIterable(asyncErrors) ? asyncErrors.merge(syncErrors).toJS() : _extends({}, asyncErrors, syncErrors);
};
...
var handleSubmit = function handleSubmit(submit, props, valid, asyncValidate, fields) {
  ...
  if (valid || persistentSubmitErrors) {
    ...
    setSubmitFailed.apply(undefined, _toConsumableArray(fields));
    var errors = mergeErrors({ asyncErrors: asyncErrors, syncErrors: syncErrors });
    if (onSubmitFail) {

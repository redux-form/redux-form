...
## Installation
```npm install --save redux-form@6.0.0-alpha.15```

## Documentation

* [Getting Started](http://redux-form.com/6.0.0-alpha.15/docs/GettingStarted.md/)
* [Examples](http://redux-form.com/6.0.0-alpha.15/examples/)
* [API](http://redux-form.com/6.0.0-alpha.15/docs/api/)
* [FAQ](http://redux-form.com/6.0.0-alpha.15/docs/faq/)
